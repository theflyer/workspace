...
public class MonteCarlo {
	...
	public static void main (String[] args) {
	 ...
	 // bin contains.
	 for ( int i : array2){
		 System.out.println(i);// printing out each element of the array in the console.
	 }
	 ...
	 for ( double i = 1.0 ; i <= 3.0; i++){
       ...
       /* Here is the method that was given to call the histogram class with 
        * adding the object s of the simulation class.
        */
