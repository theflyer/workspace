...
public class Simulation {
	...
	public ArrayList<Double> array = new ArrayList<Double>();// declaring public ArrayList()
	...
	public void generateNormalRandomNumbers (ArrayList<Double> array1,int num){
		  ...
		  this.array = array1;// referencing the public class instance arrayList by initializing with the 
